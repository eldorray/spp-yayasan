    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="flex flex-col gap-0.5">
                <h1 class="text-3xl font-bold tracking-tight text-neutral-900 dark:text-white">Edit User</h1>
                <p class="text-sm text-neutral-500 dark:text-neutral-400">
                    Editing profile details for {{ user.name }}
                </p>
            </div>
        </div>
        ...
        <div class="max-w-2xl tahoe-window">
            ...
            <div class="p-6">
                <form class="space-y-6" @submit.prevent="submit">
                    ...
                    <div class="space-y-2 flex flex-col">
                        <Label for="password" class="text-xs font-bold uppercase tracking-wider text-neutral-500 dark:text-neutral-400">New Password</Label>
                        <input
                            id="password"
