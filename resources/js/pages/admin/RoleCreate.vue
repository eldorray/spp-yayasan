    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="flex flex-col gap-0.5">
                <h1 class="text-3xl font-bold tracking-tight text-neutral-900 dark:text-white">Create Role</h1>
                <p class="text-sm text-neutral-500 dark:text-neutral-400">
                    Define a new access security role and map system permissions
                </p>
            </div>
        </div>
